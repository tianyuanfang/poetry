...
@Component({
  selector: 'app-poemgametwo',
  templateUrl: './poemgametwo.page.html',
  styleUrls: ['./poemgametwo.page.scss'],
})
export class PoemgametwoPage implements OnInit {
        ...
        if(this.time==21||this.flag){
          ...
          if(this.num!=0){
            ...
            if(this.num==5&&this.flag){
              ...
              this.nav.navigateForward("/outcome");
            }
          }

          this.question=this.allquestion[this.num]
          console.log(this.question);
          this.Q=this.Q+','+this.question.qthid;
